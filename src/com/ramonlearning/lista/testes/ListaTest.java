...
import com.ramonlearning.lista.Lista;
...
//Essa classe teste é a cópia de VetorTest, alterando apenas o Vetor ( string) para T,
// tornando mais genérico.
@DisplayName("Testes usando a classe genérica LISTA.")
class ListaTest {
    @Test
    public void  TestTamanhoUsadoDoVetorVazio(){
        int tamanho = 5;
        Lista<String> meuVetor =  new Lista(tamanho);
    ...
    public void TestAumentarCapacidadeDoVetor(){
       Lista<String> meuVetor = new Lista(2);
        meuVetor.adiciona("1");
        meuVetor.adiciona("2");
